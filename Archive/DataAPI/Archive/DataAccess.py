...
class DataSource(object):
    GOOGLE = "Google" # intra day stock/bond data
    YAHOO = "Yahoo" # daily stock/bond data
...
class DataAccess(object):
    ...
    def __init__(self, sourcein=DataSource.YAHOO, s_datapath=None,
                 s_scratchpath=None, cachestalltime=12, verbose=True):
        '''
        ...
        try:
            ...
            self.rootdir = os.path.normpath(os.path.join(os.path.dirname(__file__), *([".."] * 6)))
        try:
        ...
        if (sourcein == DataSource.GOOGLE):
            ...
            self.folderList.append(os.path.join(self.datadir + "\Google\\"))
            ...
            self.folderList.append(os.path.join(self.datadir + "\Cryptocompare\\"))
            self.accountFiles = ['test.txt']
            self.fileExtensionToRemove = ".csv"

        elif (sourcein == DataSource.POLONIEX):
            self.source = DataSource.POLONIEX
            self.folderList.append(os.path.join(self.datadir + "\Poloniex\\"))
            self.accountFiles = ['test.txt']
            self.fileExtensionToRemove = ".csv"

        elif (sourcein == DataSource.YAHOO):
            self.source = DataSource.YAHOO
            self.folderList.append(os.path.join(self.datadir + "\Yahoo\\"))
            self.accountFiles = ['test.txt']
            self.fileExtensionToRemove = ".csv"
    ...
    def get_info_from_account(self, ls_accountfiles=None):
