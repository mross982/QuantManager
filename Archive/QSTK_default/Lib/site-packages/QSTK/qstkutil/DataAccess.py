...
class DataAccess(object):
    ...
    def get_data_hardread(self, ts_list, symbol_list, data_item, verbose=True, bIncDelist=False):
        '''
    ...
    def get_data (self, ts_list, symbol_list, data_item, verbose=False, bIncDelist=False):
        ...
        if os.path.exists(cachefilename):
            if ((dt.datetime.now() - dt.datetime.fromtimestamp(os.path.getmtime(cachefilename))) < cachestall):
                if verbose:
                    print "cache hit"
                    # print "cache criteria" + str(dt.datetime.now() - dt.datetime.fromtimestamp(os.path.getmtime(cachefilename)))
                try:
...
if __name__ == '__main__':
    ...
    # Check if QWERTY is a valid symbol.6
