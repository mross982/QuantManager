...
def scrape_fund_families():
    ...
    #************ Notes **********************
    # pd.DataFrame.loc can take two indexers. When only one indexer is provided, it applies th the index of the dataframe
    # and the missing indexer is assumed to represent all columns. The following example is equivalent
    # df.loc[i]  ==  df.loc[i, :]
