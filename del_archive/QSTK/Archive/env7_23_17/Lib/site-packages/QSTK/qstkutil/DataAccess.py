    ...
    def __init__(self, sourcein=DataSource.YAHOO, s_datapath=None,
        ...
        try:
            ...
            if s_datapath != None:
                ...
                self.scratchdir = os.path.join(tempfile.gettempdir(), 'QSScratch')
        try:
            self.repodir = os.environ['QSREPO']
        except:
            self.repodir = os.path.normpath(os.path.join(self.rootdir, *([".."] * 5)))
        try:
            self.accountdir = os.environ['ACCOUNTS']
        except:
            self.accountdir = os.path.join(self.repodir, 'Accounts\\')
  
        if verbose:
            print "Scratch Directory: ", self.scratchdir
            print "Data Directory: ", self.rootdir
            print "Repository Directory: ", self.repodir
        ...
        if (sourcein == DataSource.GOOGLE):
            ...
            self.folderList.append(os.path.join(self.rootdir + "\Google\\"))
            ...
            self.folderList.append(os.path.join(self.rootdir + "\Cryptocompare\\"))
            self.accountFiles = ['test.txt']
            self.fileExtensionToRemove = ".csv"

        elif (sourcein == DataSource.POLONIEX):
            self.source = DataSource.POLONIEX
            self.folderList.append(os.path.join(self.rootdir + "\Poloniex\\"))
            self.accountFiles = ['test.txt']
            self.fileExtensionToRemove = ".csv"

        elif (sourcein == DataSource.YAHOO):
            self.source = DataSource.YAHOO
            self.folderList.append(os.path.join(self.rootdir + "\Yahoo\\"))
            self.accountFiles = ['test.txt']
            self.fileExtensionToRemove = ".csv"
